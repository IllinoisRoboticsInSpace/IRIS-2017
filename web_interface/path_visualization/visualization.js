...
var testData4 = '{"data":[[-10, -10],[10, -10],[10, 10],[-10, 10],[-10, -10]]}';
...
function randomTestPath(svgElement) {
	...
	if(selection == 1) {
		...
		var parsedData = JSON.parse(testData4);
	}
	else {
	...
	height = document.getElementById("path-image").offsetWidth;
	width = document.getElementById("path-image").offsetHeight;
...
window.onload = function() {
	...
	//Set the height and width variables
	height = document.getElementById("path-image").offsetWidth - 50;
	width = document.getElementById("path-image").offsetHeight - 50;
